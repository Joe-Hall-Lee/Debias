...
def calculate_metrics(gt_answer_file_path, sequential_pred_answer_file_path, reversed_pred_answer_file_path, if_filter_minus_one=True):
    ...
    metrics_dict['reverse_accuracy'] = accuracy_score(y_true_reverse, reversed_pred_win_list)
    metrics_dict['average_accuracy'] = (metrics_dict['reverse_accuracy'] + metrics_dict['accuracy']) / 2
...
if __name__ == '__main__':
    ...
    sequential_pred_answer_file_path = "/share/project/lianghuizhu/JudgeLM-Project/JudgeLM/judgements_output3/JudgeLM/7b-full-model-pycharm-debug-v2"
    #
    # 33b 100k full model lr 3e-5
    reversed_pred_answer_file_path = "/share/project/lianghuizhu/JudgeLM-Project/JudgeLM/judgements_output3/JudgeLM/7b-full-model-pycharm-debug-reverse-v2"
