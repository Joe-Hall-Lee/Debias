...
with open("/home/disk/huanghui/data/judgelm/better.json", 'r') as fin:
...
with open("/home/disk/huanghui/data/judgelm/sft.json", 'r') as fin:
    SFT = json.load(fin)
neighbor = torch.load("/home/disk/huanghui/data/judgelm/embeddings/neighbor500_better.bin")

# Open the new jsonl file for writing converted data
os.makedirs("/home/disk/huanghui/data/judgelm/threshold", exist_ok=True)
with open("/home/disk/huanghui/data/judgelm/threshold/formatted.jsonl", 'w') as fout:
